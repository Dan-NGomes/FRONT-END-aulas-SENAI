function atividade1(){
    let clientes = Number(window.prompt("Insira a quantidade de cliente"));
...
function atividade2(){
    let numero = Number(window.prompt("Insira um número"));
        ...
        window.alert(`O número escolhido é: ${numero}, o sucessor é ${numero+1} e e seu antecessor é ${numero-1}`);
